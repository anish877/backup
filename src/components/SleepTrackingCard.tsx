...
const apiService = {
  ...
  getLatestSleepData: async () => {
    try {
      const response = await axios.get('https://healthbackend-production-157d.up.railway.app/api/sleep',{withCredentials: true});
  ...
  getSleepDataByDate: async (date: string) => {
    try {
      const response = await axios.get(`https://healthbackend-production-157d.up.railway.app/api/sleep?date=${date}`, {withCredentials: true});
  ...
  saveSleepData: async (sleepData: any) => {
    try {
      const response = await axios.post('https://healthbackend-production-157d.up.railway.app/api/sleep', sleepData, {withCredentials: true});
      return response.data.sleep;
    } catch (error) {
